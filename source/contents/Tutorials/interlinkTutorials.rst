...
.. dropdown:: HyperCells package:
   ...
   .. dropdown:: Export:
      ...
      `Coherent sequences`_, `Flat-bands`_, `Haldane model`_, `Hatano-Nelson model`_, `Supercells`_
   .. dropdown:: FpGroup:
   ...
   .. dropdown:: TGCellGraph:
      ...
      `Coherent sequences`_, `Flat-bands`_, `Haldane model`_, `Supercells`_
   ...
   .. dropdown:: TessellationModelGraph:
      ...
      `Coherent sequences`_, `Haldane model`_, `Hatano-Nelson model`_, `Supercells`_
   .. dropdown:: TriangleGroup:

      `Coherent sequences`_, `Haldane model`_


.. dropdown:: HyperBloch package:
   :color: danger
   :icon: package

   .. dropdown:: AbelianBlochHamiltonian:

      `Flat-bands`_, `Haldane model`_, `Hatano-Nelson model`_, `Higher-order topology`_, `Supercells`_
   ...
   .. dropdown:: ImportCellGraphString:
      ...
      `Flat-bands`_, `Haldane model`_, `Hatano-Nelson model`_
   .. dropdown:: ImportModelGraphString:

      `Flat-bands`_, `Haldane model`_, `Hatano-Nelson model`_, `Supercells`_
   ...
   .. dropdown:: ShowCellBoundary:
      ...
      `Flat-bands`_, `Haldane model`_, `Hatano-Nelson model`_, `Higher-order topology`_
